...
- Add a new Controller for our project `openinfra-summit` which watches and reconciles the `Cloner` resource. Once this is done using the operator-sdk command line, this will scaffold a new Controller implementation under `pkg/controller/cloner/`
